...
'.doc ol{list-style:none;counter-reset:pm-ol;padding-left:2em;}',
'.doc ol > li{position:relative;counter-increment:pm-ol;}',
'.doc ol > li::before{content:counters(pm-ol, ".") ".";position:absolute;right:100%;margin-right:.4em;white-space:nowrap;color:#6b6660;font-variant-numeric:tabular-nums;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;font-size:.95em;}',
